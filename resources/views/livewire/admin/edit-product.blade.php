<div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-gray-700">
        <h1 class="text-2xl text-center font-semibold mb-8">Producto</h1>
        ...
        <div class="bg-white shadow-xl rounded-lg p-6">
            ...
            <div class="grid grid-cols-2 gap-6 mb-4">
                ...
                {{-- Precio --}}
                <div>
                    <x-jet-label value="Precio por gramo" />
    ...
    @push('script')
        <script>
            ...
            Livewire.on('deleteProduct', () => {
                Swal.fire({
                    title: '¡Vaya vaya!',
                    text: "Ya no hay retorno mushulero",
                    icon: 'Peligro',
                    showCancelButton: true,
                    confirmButtonColor: '#3085d6',
                    cancelButtonColor: '#072B7B',
                    confirmButtonText: '¡Mushulero seguro!'
                }).then((result) => {
                    if (result.isConfirmed) {
                        Livewire.emitTo('admin.edit-product', 'delete');
                        Swal.fire(
                            'Se borro',
                            'Que le vaya mushulera',
                            'Next'
                        )
                    }
                })
