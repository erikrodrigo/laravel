<?php $attributes = $attributes->exceptProps(['size' => 35, 'color' => 'semilla']); ?>
<?php foreach (array_filter((['size' => 35, 'color' => 'semilla']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
?>
<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="<?php echo e($size); ?>" height="<?php echo e($size); ?>"
    viewBox="0 0 226 226" style=" fill:#ffffff;">
...
<?php /**PATH C:\xampp\htdocs\mushugranel\resources\views/components/search.blade.php ENDPATH**/ ?>